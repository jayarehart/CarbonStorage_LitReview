...
my_auth = ElsAuthor(uri='https://api.elsevier.com/content/author/author_id/56496980900')
...
aff_srch = ElsSearch('affil(colorado)', 'affiliation')
...
doc_srch = ElsSearch("AUTHOR-NAME(Arehart) AND PUBYEAR > 2010", 'scopus')
doc_srch.execute(client, get_all=True)
print("doc_srch has", len(doc_srch.results), "results.")
